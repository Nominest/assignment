let users = [
      ...
      },
    {
      ...
      function score(list) {
        let userListPoint = '';
        for (i = 0; i < list[i].points.length; i++) {
            if (userListPoint < list[i].points )
            userListPoint = list[i].points
        }
        return userListPoint;
      }
